...
public class MudBrickItem extends YeetABrickModElements.ModElement {
	@ObjectHolder("yeet_a_brick:mud_brick")
	public static final Item block = null;
	@ObjectHolder("yeet_a_brick:entitybulletmud_brick")
	public static final EntityType arrow = null;
	public MudBrickItem(YeetABrickModElements instance) {
		super(instance, 27);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletmud_brick").setRegistryName("entitybulletmud_brick"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Items.BRICK, (int) (1));
		}
