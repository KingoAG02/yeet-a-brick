...
public class GrindingBowlItem extends YeetABrickModElements.ModElement {
	@ObjectHolder("yeet_a_brick:grinding_bowl")
	public static final Item block = null;
	public GrindingBowlItem(YeetABrickModElements instance) {
		super(instance, 17);
	}
