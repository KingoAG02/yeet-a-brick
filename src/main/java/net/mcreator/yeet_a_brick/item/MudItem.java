...
import net.mcreator.yeet_a_brick.procedures.MudBulletHitsLivingEntityProcedure;
...
public class MudItem extends YeetABrickModElements.ModElement {
	@ObjectHolder("yeet_a_brick:mud")
	public static final Item block = null;
	@ObjectHolder("yeet_a_brick:entitybulletmud")
	public static final EntityType arrow = null;
	public MudItem(YeetABrickModElements instance) {
		super(instance, 24);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletmud").setRegistryName("entitybulletmud"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.MATERIALS).maxDamage(100));
			setRegistryName("mud");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.7f, 3, 3);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				MudBulletHitsLivingEntityProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("yeet_a_brick:textures/mud_bullet.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new Modelmud_bullet();
	...
	public static class Modelmud_bullet extends EntityModel<Entity> {
		private final ModelRenderer bb_main;
		public Modelmud_bullet() {
			textureWidth = 16;
			textureHeight = 16;
