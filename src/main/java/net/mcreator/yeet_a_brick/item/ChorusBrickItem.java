...
package net.mcreator.yeet_a_brick.item;
...
import net.mcreator.yeet_a_brick.procedures.ChorusBrickBulletHitsLivingEntityProcedure;
...
public class ChorusBrickItem extends YeetABrickModElements.ModElement {
	@ObjectHolder("yeet_a_brick:chorus_brick")
	public static final Item block = null;
	@ObjectHolder("yeet_a_brick:entitybulletchorus_brick")
	public static final EntityType arrow = null;
	public ChorusBrickItem(YeetABrickModElements instance) {
		super(instance, 21);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletchorus_brick").setRegistryName("entitybulletchorus_brick"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.3f, 4, 2);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				ChorusBrickBulletHitsLivingEntityProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("yeet_a_brick:textures/chorusbrick1.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new ModelBrick();
	...
	// Date: 31-08-2020 3.24.32 PM
	// Template version 1.1
	// Java generated by Techne
	// Keep in mind that you still need to fill in some blanks
	// - ZeuX
	public static class ModelBrick extends EntityModel<Entity> {
		// fields
		...
		public void render(MatrixStack ms, IVertexBuilder vb, int i1, int i2, float f1, float f2, float f3, float f4) {
			Shape1.render(ms, vb, i1, i2, f1, f2, f3, f4);
		}
