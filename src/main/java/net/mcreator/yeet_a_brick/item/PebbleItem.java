...
public class PebbleItem extends YeetABrickModElements.ModElement {
	@ObjectHolder("yeet_a_brick:pebble")
	public static final Item block = null;
	@ObjectHolder("yeet_a_brick:entitybulletpebble")
	public static final EntityType arrow = null;
	public PebbleItem(YeetABrickModElements instance) {
		super(instance, 30);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletpebble").setRegistryName("entitybulletpebble"));
	}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("yeet_a_brick:textures/pebble.png");
