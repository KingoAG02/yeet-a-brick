...
public class NetherBrickItem extends YeetABrickModElements.ModElement {
	@ObjectHolder("yeet_a_brick:nether_brick")
	public static final Item block = null;
	@ObjectHolder("yeet_a_brick:entitybulletnether_brick")
	public static final EntityType arrow = null;
	public NetherBrickItem(YeetABrickModElements instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletnether_brick").setRegistryName("entitybulletnether_brick"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.3f, 3.9999999999999996, 2);
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("yeet_a_brick:textures/netherbrick1.png");
