...
public class BrickItem extends YeetABrickModElements.ModElement {
	@ObjectHolder("yeet_a_brick:brick")
	public static final Item block = null;
	@ObjectHolder("yeet_a_brick:entitybulletbrick")
	public static final EntityType arrow = null;
	public BrickItem(YeetABrickModElements instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletbrick").setRegistryName("entitybulletbrick"));
	}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("yeet_a_brick:textures/brick2.png");
